...
$toEmail = "iseet@internet.ru"; // Replace Your Email Address
...
$fromEmail = "iseet@internet.ru";  // Replace Company's Email Address (preferably currently used Domain Name)
$fromName = "IseeT"; // Replace Company Name
